        ...
        runLoader(
            ...
            function (err, result) {
                ...
                runLoader(
                    ...
                    path.join(fixtures, "include"),
                    nestedTemplate,
                    fs.readFileSync(nestedTemplate, "utf-8"),
                    function (err, result) {
                        if (err) throw err;
